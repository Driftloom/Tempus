...
async def test_complete_user_registration_and_login():
    ...
    async with AsyncClient(app=app, base_url="http://test") as client:
        ...
        if login_response.status_code == 200:
            ...
            assert tasks_response.status_code in [200, 401]
...
async def test_complete_email_processing_workflow():
    ...
    async with AsyncClient(app=app, base_url="http://test") as client:
        ...
        if login_response.status_code == 200:
            ...
            assert process_response.status_code in [200, 401]
    ...
    async with AsyncClient(app=app, base_url="http://test") as client:
        ...
        if login_response.status_code == 200:
            ...
            if create_response.status_code in [200, 201]:
                ...
                assert mark_response.status_code in [200, 404, 401]
...
async def test_complete_agent_workflow():
    ...
    async with AsyncClient(app=app, base_url="http://test") as client:
        ...
        if login_response.status_code == 200:
            ...
            assert start_response.status_code in [200, 401]
