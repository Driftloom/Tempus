...
class GmailConnector:
    ...
    async def _fetch_message_detail(self, message_id: str, headers: Dict) -> Optional[Dict]:
    ...
    async def authenticate(self, access_token: str, refresh_token: Optional[str] = None) -> Dict:
